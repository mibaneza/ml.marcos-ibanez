...
public class ContactResource {
	...
	@GetMapping(value = "security/contact", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PreAuthorize("hasRole('ADMIN')")
	@ResponseStatus(HttpStatus.OK)
	@DeleteMapping(value = "security/contact", produces = MediaType.APPLICATION_JSON_VALUE)
